...
<section>
  ...
  <tr>
  <td> <br><br> <form action = 'reportFriend.php?reportedUser=".$row["username"]."' method='POST'>
    <button>Report Friend</button>
  </form> </td><br>
  </tr>
...
<br><br>";
  while ($friendship = mysqli_fetch_array($sel3)) {
                      ...
                      <tr>
                      <td> ".$friendship['friends_username']."</td>
                      </tr>
